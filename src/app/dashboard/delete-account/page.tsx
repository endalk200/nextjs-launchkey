      ...
      <div className="container mx-auto max-w-2xl p-6">
        <Card className="border-destructive">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              This account deletion link is invalid, expired, or has already
              been used.
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4 text-center">
            <p className="text-muted-foreground text-sm">
              If you want to delete your account, please request a new deletion
    ...
    <div className="container mx-auto max-w-2xl p-6">
      <div className="space-y-6">
        ...
        {session?.user && (
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Account to be deleted</CardTitle>
            </CardHeader>
        ...
        <Card className="border-destructive bg-destructive/5">
          ...
          <CardContent className="space-y-3">
            ...
            <ul className="ml-4 space-y-1 text-sm">
              ...
              <li className="flex items-center gap-2">
                <div className="bg-destructive h-1.5 w-1.5 rounded-full" />
                Make your email address available for new registrations
              </li>
            </ul>
          </CardContent>
        </Card>
