        ...
        <div className="from-background to-secondary/20 min-h-screen bg-gradient-to-b">
            ...
            <section className="mx-auto max-w-7xl px-4 py-24 text-center sm:px-6 lg:px-8">
                ...
                <p className="text-muted-foreground mx-auto mb-8 max-w-2xl text-lg">
                    A powerful starter template with Next.js 15, tRPC, Prisma,
                    TypeScript, and Better Auth. Everything you need to build
                    modern web applications with authentication built-in.
                </p>
            ...
            <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-muted-foreground">
                                Built-in email/password authentication with
                                Better Auth. Session management, middleware
                                protection, and more.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-muted-foreground">
                                Next.js 15 with App Router, React 19, tRPC for
                                type-safe APIs, and Tailwind CSS for beautiful
                                styling.
                            </p>
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <p className="text-muted-foreground">
                                Full TypeScript support, Prisma ORM, ESLint,
                                Prettier, and hot reload for the best
            ...
            <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
                <div className="bg-primary/10 rounded-lg p-8 text-center">
                    ...
                    <p className="text-muted-foreground mb-6">
                        ...
                        applications with NextCelerator.
                    </p>
                    <Button size="lg" asChild>
